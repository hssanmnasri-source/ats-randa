...
def generate_matching_pdf(
    ...
    Lève ImportError si reportlab n'est pas installé.
    """
    ...
    def _decision_color(decision: str):
        return {"RETAINED": RANDA_GREEN, "REFUSED": RANDA_RED}.get(decision, RANDA_GREY)
    ...
    # ── En-tête ────────────────────────────────────────────────────────────────
    title_style = ParagraphStyle("RandaTitle", parent=styles["Title"],
        textColor=RANDA_RED, fontSize=22, leading=28, spaceAfter=4)
    sub_style = ParagraphStyle("RandaSub", parent=styles["Normal"],
        textColor=RANDA_GREY, fontSize=10, leading=14, spaceAfter=2)
    label_style = ParagraphStyle("RandaLabel", parent=styles["Normal"],
        textColor=RANDA_DARK, fontSize=10, fontName="Helvetica-Bold")
    value_style = ParagraphStyle("RandaValue", parent=styles["Normal"],
        textColor=RANDA_GREY, fontSize=10)
    ...
    header_style = ParagraphStyle("TblHeader", parent=styles["Normal"],
        textColor=WHITE, fontSize=9, fontName="Helvetica-Bold", alignment=TA_CENTER)
    cell_style = ParagraphStyle("TblCell", parent=styles["Normal"],
        textColor=RANDA_DARK, fontSize=8, alignment=TA_LEFT)
    score_style = ParagraphStyle("TblScore", parent=styles["Normal"],
        textColor=RANDA_DARK, fontSize=8, alignment=TA_CENTER)
    ...
    for row in results:
        ...
        dec_style = ParagraphStyle(f"Dec_{row['id']}", parent=styles["Normal"],
            textColor=_decision_color(decision), fontSize=8,
    ...
    footer_style = ParagraphStyle("Footer", parent=styles["Normal"],
        textColor=RANDA_GREY, fontSize=8, alignment=TA_CENTER)
